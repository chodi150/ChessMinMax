...
object Main extends App{
  ...
  val chessBoardState = chessBoardState1.makeMove(Position(1,0,1), Position(4,2,1))
  val chessBoardState2 = chessBoardState.makeMove(Position(6,2,1), Position(4,2,1))
